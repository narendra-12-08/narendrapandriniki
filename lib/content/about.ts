export const bio = `I'm Narendra Pandrinki, an independent DevOps, platform, and SRE engineer based in Hyderabad, India. I've spent the last five years building and operating production platforms for teams that take reliability, audit trails, and engineering velocity seriously — most of that time inside fintech and payments, with the rest spread across B2B SaaS, healthtech, e-commerce, AI/ML infrastructure, and marketplaces.
