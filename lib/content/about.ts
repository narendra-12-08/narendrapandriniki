export const bio = `I'm Narendra Pandrinki, an independent DevOps, platform, and SRE engineer based in the UK. I've spent the last five years building and operating production platforms for teams that take reliability, audit trails, and engineering velocity seriously — most of that time inside fintech and payments, with the rest spread across B2B SaaS, healthtech, e-commerce, AI/ML infrastructure, and marketplaces.

I started my career inside fintech because that's where the gap between "it works" and "it works under scrutiny" matters most. Payments platforms taught me that reliability is a property of the whole system — the deploy pipeline, the audit log, the on-call rotation, the cost line — and that fixing reliability one component at a time rarely works. The lessons travelled well. The work I do now in healthtech, marketplaces, and AI/ML infra uses the same instincts: deliberate boundaries, tested failovers, observability tied to user journeys, and the unglamorous discipline that turns audits and peak events from fire drills into routine.

I went independent because I prefer the shape of the work. A focused engagement with a team that needs senior platform leadership for a defined period beats most full-time roles, for me and for the customer. I take on a small number of engagements at any one time so the attention is real, and I work alongside in-house teams rather than in parallel to them — pairing, code review, and knowledge transfer happen continuously, not at handover. The engagement ends when the in-house team can operate everything I built.`;
...
export const timeline: { year: string; title: string; description: string }[] = [
  {
    year: "2021",
    title: "First DevOps role inside a UK fintech",
    description:
      "Joined a payments company as a junior DevOps engineer. First exposure to production systems where every change touches money — and to the audit trail discipline that came with it. Spent the year on AWS, Terraform, and the unfashionable parts of reliability engineering.",
  },
  {
    year: "2022",
    title: "Platform team at a Series-B fintech",
    description:
      "Joined the platform team at a faster-growing fintech and led the rebuild of their CI/CD pipeline and observability stack. Cut mainline build time by 60%, replaced threshold alerts with burn-rate SLOs, and got the on-call rotation down from a noise generator to a working tool.",
  },
  {
    year: "2023",
    title: "Senior DevOps engineer; multi-region work",
    description:
      "Stepped into a senior role and led the multi-region foundation work for a payments platform — logical replication, idempotency at the request layer, tested failover with real game days. First time I owned an architecture from design through operational maturity.",
  },
  {
    year: "2024",
    title: "Cross-industry SRE and platform consulting",
    description:
      "Started taking on engagements outside fintech — first in B2B SaaS, then in healthtech and e-commerce. Discovered that the patterns travelled: deliberate boundaries, tested failovers, observability tied to user journeys. Began the transition toward independent work.",
  },
  {
    year: "2025",
    title: "Went independent",
    description:
      "Left full-time employment to work as an independent DevOps and platform engineer. Project, retainer, and fractional engagements across fintech, healthtech, AI/ML infrastructure, and marketplaces. The shape of the work suits me; the customers seem happy.",
  },
  {
    year: "2026",
...
export const availability = `I take on a small number of engagements at any one time, with a hard cap of one full-time-equivalent across all clients. New project slots usually open at the start of each quarter; retainer and fractional capacity opens less predictably. If you're considering an engagement that needs to start within the next 30 days, get in touch directly and I'll be honest about whether I can fit it in. If I can't, I often know someone good who can.`;
